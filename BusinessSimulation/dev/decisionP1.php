        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    ?>
                    <h2 class="section-heading">Mes positions - CapGemini</h2>
                    <hr class="light">
                    <p class="text">Chiffre d'affaire réalisé en 2015 sur chaque zone et chaque secteur d'activité. Total : <?php echo $ca;?> </p>
                    </br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="light">
                    <p class="text-faded">Matrice des taux de croissance en 2015 par activité et par zone géographique.</p>
                    </br>
