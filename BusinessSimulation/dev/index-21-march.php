...
<?php
                ...
                include 'getYear.php';
				function currencyFormat($value, $decimals = 0 ,  $dec_point = "." ,  $thousands_sep = ","){
					return '<span class="notranslate">'.number_format($value,$decimals,$dec_point,$thousands_sep).' M$</span>';
				}
?>
        ...
        <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo currencyFormat(13500); ?> </td>
                            <td><?php 
							$turnover_2016= 14069;
							echo currencyFormat(14069); ?> </td>
                            <td><?php 
							...
							echo currencyFormat($resultats2017org);
                            ...
                            echo currencyFormat($resultats2017);
                            ?>  </td>
                            <td><?php 
                            ...
                            echo currencyFormat($resultats2018org);
                            ?>  </td>
                            <td><?php 
                            ...
                            echo currencyFormat($resultats2018);
                            ?>  </td>
                            <td><?php 
                            ...
                            echo currencyFormat($resultats2019org);
                            ?>  </td>
                            <td><?php 
                            ...
                            echo currencyFormat($resultats2019);
                            ?>  </td>
                            <td><?php 
                            ...
                            echo currencyFormat($resultats2020org);
                            ?>  </td>
                            <td><?php 
                            ...
                            echo currencyFormat($resultats2020);
                            ?>  </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo currencyFormat(1511);
                            ?>  </td>
                            <td><?php echo currencyFormat(1613);
                            ?> </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 2 AND player = 1");
                                ...
                                echo currencyFormat($ebit2017org);
                                ?>  </td>
                            ...
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2018 AND step = 2 AND player = 1");
                                ...
                                echo currencyFormat($ebit2018org);
                                ?>  </td>
                            ...
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2019 AND step = 2 AND player = 1");
                                ...
                                echo currencyFormat($ebit2019org);
                                ?>  </td>
                            ...
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2020 AND step = 2 AND player = 1");
                                ...
                                echo currencyFormat($ebit2020org);
                                ?>  </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2020 AND step = 3 AND player = 1");
                                ...
                                echo currencyFormat($ebit2020);
                                ?>  </td>
                        </tr>
                        
                        <tr>
                            <td>Croissance du résultat d'exploitation</td>
                            <td>N/A </td>
                            <td>N/A </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 2 AND player = 1");
                                $pos=array();
                                ...
                                //echo $ebit2017org;die;
                                echo round(100*($ebit2017org*$ebit2017org/(1511*$ebit2017org)-1),2);
                               // echo $ebit2017org;
                            ...
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 3 AND player = 1");
                                ...
                                echo round(100*($ebit2017*$ebit2017/($ebit2017*1613)-1),2);
                               // echo $ebit2017;
                                ?> %</td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2018 AND step = 2 AND player = 1");
                                $pos=array();
                                ...
                                echo round(100*($ebit2018org*$ebit2018org/($ebit2018org*$ebit2017)-1),2);
                               // echo $ebit2018org;
                                ?> % </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2018 AND step = 3 AND player = 1");
                                $pos=array();
                                ...
                                echo round(100*($ebit2018*$ebit2018/($ebit2018*$ebit2017)-1),2);
                            ...
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2019 AND step = 2 AND player = 1");
                                ...
                                echo round(100*($ebit2019org*$ebit2019org/($ebit2019org*$ebit2018)-1),2);
                               // echo $ebit2019org;
                                ?> %</td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2019 AND step = 3 AND player = 1");
                                $pos=array();
                                ...
                                echo round(100*($ebit2019*$ebit2019/($ebit2019*$ebit2018)-1),2);
                               // echo $ebit2019;
                                ?> % </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2020 AND step = 2 AND player = 1");
                                $pos=array();
                                ...
                                echo round(100*($ebit2020org*$ebit2020org/($ebit2020org*$ebit2019)-1),2);
                               // echo $ebit2020org;
                                ?> % </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2020 AND step = 3 AND player = 1");
                                $pos=array();
                                ...
                                echo round(100*($ebit2020*$ebit2020/($ebit2020*$ebit2019)-1),2);
                               // echo $ebit2020;
                                ?> % </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>/ </td>
                            <td><?php echo currencyFormat(1187);
                                ?> </td>
                            <td>/ </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 3 AND player = 1");
                                $pos=array();
                                ...
                                echo currencyFormat($ebit2017*0.78,2);
                                ?>  </td>
                            <td>/ </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2018 AND step = 3 AND player = 1");
                                $pos=array();
                                ...
                                echo currencyFormat($ebit2018*0.78,2);
                                ?>  </td>
                            <td>/ </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2019 AND step = 3 AND player = 1");
                                $pos=array();
                                ...
                                echo currencyFormat($ebit2019*0.78,2);
                                ?>  </td>
                            <td>/ </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2020 AND step = 3 AND player = 1");
                                $pos=array();
                                ...
                                echo currencyFormat($ebit2020*0.78,2);
                                ?>  </td>
                        </tr>
                        ...
                        <tr>
                            <td>Dette nette</td>
                            <td>/ </td>
                            <td><?php echo currencyFormat(1500);
                                ?> </td>
                            <td>/</td>
                        ...
                        <tr>
                            ...
                            <td>/ </td>
                            <td><?php echo currencyFormat(14960);?>  </td>
                            <td>/ </td>
                            <td><?php echo currencyFormat($cap2017);?> </td>
                            <td>/ </td>
                            <td><?php echo currencyFormat($cap2018);?>  </td>
                            <td>/ </td>
                            <td><?php echo currencyFormat($cap2019);?>  </td>
                            <td>/ </td>
                            <td><?php echo currencyFormat($cap2020);?>  </td>
                        </tr>
						...
						<tr>
                            <td>Croissance du revenu</td>
							<td>N/A</td>
							<td>N/A</td>
							<td><?php echo round(100*(($resultats2017org/$turnover_2016)-1),2).'%';
							 ?>  </td>
							<td><?php  echo round(100*(($resultats2017/$turnover_2016) -1),2).'%';?></td>
                            <td><?php  echo (($resultats2017>0)?round(100*(($resultats2018org/$resultats2017)-1),2):0).'%';?></td>
                            <td><?php  echo (($resultats2017>0)?round(100*(($resultats2018/$resultats2017)-1),2):0).'%';?></td>
                            <td><?php  echo (($resultats2018>0)?round(100*(($resultats2019org/$resultats2018)-1),2):0).'%';?></td>
                            <td><?php  echo (($resultats2018>0)?round(100*(($resultats2019/$resultats2018)-1),2):0).'%';?></td>
							<td><?php  echo (($resultats2019>0)?round(100*(($resultats2020org/$resultats2019)-1),2):0).'%';?></td>
							<td><?php  echo (($resultats2019>0)?round(100*(($resultats2020/$resultats2019)-1),2):0).'%';?></td>
    ...
    <section>
        ...
        <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Chiffre d'affaires total</td>
                            <td><?php echo currencyFormat(11794 ); ?></td>
                            <td><?php 
							$turnover_2016 =13094;
							echo currencyFormat(13094 ); ?></td>
                            <td><?php 
                        ...
                        <tr>
                            <td>Résultat opérationnel</td>
                            <td><?php echo currencyFormat(1120); ?> </td>
                            <td><?php echo currencyFormat(1198); ?> </td>
                        ...
                        <tr>
                            ...
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 2 AND player = 2");
                                ...
                                echo round(100*($ebit2017org*$ebit2017org/(1120*$ebit2017org)-1),2);
                                //echo $ebit2017org;
                                ?> % </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 3 AND player = 2");
                                $pos=array();
                                ...
                                echo round(100*($ebit2017*$ebit2017/($ebit2017*1198)-1),2);
                               // echo $ebit2017;
                                ?> % </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2018 AND step = 2 AND player = 2");
                                $pos=array();
                        ...
                        <tr>
                            <td>Flux de trésorerie</td>
                            <td>/ </td>
                            <td><?php echo currencyFormat(846); ?></td>
                            <td>/ </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 3 AND player = 2");
                                $pos=array();
                                while ($data = $req->fetch())
                        ...
                        <tr>
                            <td>Dette nette</td>
                            <td>/ </td>
                            <td><?php echo currencyFormat(-480); ?> </td>
                            <td>/</td>
                        ...
                        <tr>
                            <td>Capitalisation boursière</td>
                            <td>/ </td>
                            <td><?php echo currencyFormat(10400);?> </td>
                            <td>/ </td>
                            <td><?php echo currencyFormat($cap2017);?>  </td>
                            <td>/ </td>
                            <td><?php echo currencyFormat($cap2018);?>  </td>
                            ...
                            <td><?php echo currencyFormat($cap2019);?> </td>
                            <td>/ </td>
                            <td><?php echo currencyFormat($cap2020);?> M$ </td>
                        </tr>
                        <tr>
                            <td>Dividendes versés</td>
                            <td>/ </td>
    ...
    <section class="bg-dark">
        ...
        <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Chiffre d'affaires total</td>
                            <td><?php echo currencyFormat(33390); ?></td>
                            <td><?php $turnover_2016=34300;
							echo currencyFormat(34300); ?></td>
                            <td><?php 
                        ...
                        <tr>
                            <td>Résultat opérationnel</td>
                            <td><?php echo currencyFormat(4771) ?> </td>
                            <td><?php echo currencyFormat(4819) ?>  </td>
                        ...
                        <tr>
                            ...
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 2 AND player = 3");
                                ...
                                echo round(100*($ebit2017org*$ebit2017org/(4771*$ebit2017org)-1),2);
                               // echo $ebit2017org;
                                ?> % </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 3 AND player = 3");
                                $pos=array();
                                ...
                                echo round(100*($ebit2017*$ebit2017/($ebit2017*4819)-1),2);
                              //  echo $ebit2017;
                                ?> % </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2018 AND step = 2 AND player = 3");
                                $pos=array();
                        ...
                        <tr>
                            <td>Flux de trésorerie</td>
                            <td>/ </td>
                            <td><?php echo currencyFormat(3834); ?></td>
                            <td>/ </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 3 AND player = 3");
                                $pos=array();
                                while ($data = $req->fetch())
    ...
    <section>
        ...
        <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Chiffre d'affaires total</td>
                            <td><?php echo currencyFormat(17623); ?></td>
                            <td><?php $turnover_2016 =17623; 
							echo currencyFormat(17623); ?></td>
                            <td><?php 
                        ...
                        <tr>
                            <td>Résultat opérationnel</td>
                            <td><?php echo currencyFormat(4329); ?> </td>
                            <td><?php echo currencyFormat(4329); ?> </td>
...
<tr>
                            ...
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 2 AND player = 4");
                                ...
                                echo round(100*($ebit2017org*$ebit2017org/(4329*$ebit2017org)-1),2);
                                //echo $ebit2017org;
                                ?> % </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2017 AND step = 3 AND player = 4");
                                $pos=array();
                                ...
                                echo round(100*($ebit2017*$ebit2017/($ebit2017*4329)-1),2);
                                //echo $ebit2017;
                                ?> % </td>
                            <td><?php $req = $bdd->query("SELECT EBIT FROM EBIT WHERE year = 2018 AND step = 2 AND player = 4");
                                $pos=array();
                        ...
                        <tr>
                            <td>Dette nette</td>
                            <td>/ </td>
                            <td><?php echo currencyFormat(-5600);
                                ?>
							  </td>
                            <td>/</td>
                        ...
                        <tr>
                            <td>Capitalisation boursière</td>
                            <td>/ </td>
                            <td><?php echo currencyFormat(72890);?>  </td>
                            <td>/ </td>
                            <td><?php echo currencyFormat($cap2017);?>  </td>
                            <td>/ </td>
                            <td><?php echo currencyFormat($cap2018);?>  </td>
